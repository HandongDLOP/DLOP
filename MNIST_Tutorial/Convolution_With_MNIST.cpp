...
int main(int argc, char const *argv[]) {
    ...
    // ======================= layer 1=======================
    Operator<float> *w1    = new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 10, 1, 3, 3, 0.0, 0.6), "weight");
    ...
    Operator<float> *w_flat = new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 1, 1, 24 * 24 * 10, 10, 0.0, 0.1), "w");
