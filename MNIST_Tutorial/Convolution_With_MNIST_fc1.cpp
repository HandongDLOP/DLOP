...
int main(int argc, char const *argv[]) {
    ...
    Operator<float>     *pool1 = HGUNN.AddOperator(new Maxpooling2D<float>(act1, 2, 2, 2, 2, VALID, "maxpool1"));
    ...
    Operator<float>     *pool2 = HGUNN.AddOperator(new Maxpooling2D<float>(act2, 2, 2, 2, 2, VALID, "maxpool2"));
