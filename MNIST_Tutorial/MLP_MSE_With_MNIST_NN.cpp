/*g++ -g -o testing -std=c++11 MLP_MSE_With_MNIST_NN.cpp ../Header/Shape.cpp ../Header/Data.cpp ../Header/Tensor.cpp ../Header/Operator.cpp ../Header/Optimizer.cpp ../Header/NeuralNetwork.cpp*/
...
int main(int argc, char const *argv[]) {
    ...
    // ======================= layer 1======================
    Operator<float> *w1      = HGUNN.AddTensorholder(new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 1, 1, 784, 100, 0.0, 0.6), "w1"));
    Operator<float> *b1      = HGUNN.AddTensorholder(new Tensorholder<float>(Tensor<float>::Constants(1, 1, 1, 1, 100, 1.0), "b1"));
    ...
    // ======================= layer 2=======================
    Operator<float> *w2      = HGUNN.AddTensorholder(new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 1, 1, 100, 10, 0.0, 0.6), "w2"));
    ...
    // ======================= Error=======================
    Operator<float> *err = HGUNN.AddOperator(new MSE<float>(act2, label, "MSE"));
