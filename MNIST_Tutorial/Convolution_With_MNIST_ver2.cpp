...
int main(int argc, char const *argv[]) {
    ...
    // ======================= layer 2=======================
    Operator<float> *w2    = new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 20, 10, 3, 3, 0.0, 0.1), "weight");
    Operator<float> *b2    = new Tensorholder<float>(Tensor<float>::Constants(1, 1, 1, 1, 20, 0.1), "bias");
    ...
    // ======================= layer 3=======================
    Operator<float> *flat = new Reshape<float>(pool2, 1, BATCH, 1, 1, 5 * 5 * 20, "flat");

    Operator<float> *w_flat1 = new Tensorholder<float>(Tensor<float>::Truncated_normal(1, 1, 1, 5 * 5 * 20, 250, 0.0, 0.1), "w");
