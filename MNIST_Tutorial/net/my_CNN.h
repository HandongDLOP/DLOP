...
public:
    my_CNN(Tensorholder<float> *x, Tensorholder<float> *label) {
        ...
        // ======================= layer 1=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 1, 32, 3, 3, 2, 2, 1, TRUE, "1"));
        ...
        // ======================= layer 2=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 32, 64, 3, 3, 2, 2, 1, TRUE, "2"));
        ...
        // ======================= layer 3=======================
        out = AddOperator(new Linear<float>(out, 7 * 7 * 64, 256, TRUE, "3"));

        out = AddOperator(new Relu<float>(out, "Relu_3"));

        // ======================= layer 4=======================
        out = AddOperator(new Linear<float>(out, 256, 10, TRUE, "4"));
