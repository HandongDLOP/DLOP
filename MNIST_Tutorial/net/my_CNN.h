...
public:
    my_CNN(Tensorholder<float> *x, Tensorholder<float> *label) {
        ...
        // ======================= layer 1=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 1, 10, 3, 3, 1, 1, 1, TRUE, "1"));
        ...
        // ======================= layer 2=======================
        out = AddOperator(new ConvolutionLayer2D<float>(out, 10, 20, 3, 3, 1, 1, 1, TRUE, "2"));
        ...
        out = AddOperator(new Reshape<float>(out, 1, 1, 7 * 7 * 20, "Flat"));

        // ======================= layer 3=======================
        out = AddOperator(new Linear<float>(out, 7 * 7 * 20, 1024, TRUE, "3"));
