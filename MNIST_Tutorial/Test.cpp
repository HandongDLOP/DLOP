...
int main(int argc, char const *argv[]) {
    ...
    Operator<float> *x     = new Placeholder<float>(new Tensor<float>(1, BATCH, 1, 1, 784), "x");
    Operator<float> *label = new Placeholder<float>(new Tensor<float>(1, BATCH, 1, 1, 10), "label");
    ...
    // ======================= Error=======================
    Operator<float> *err = new SoftmaxCrossEntropy<float>(add, label, 1e-2, "SCE");
