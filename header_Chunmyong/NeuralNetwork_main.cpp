...
int main(int argc, char const *argv[]) {
    ...
    // W_conv1 = Ark.Variable(Ark.truncated_normal({5, 5, 1, 32}, stddev=0.1));
    // b_conv1 = Ark.Variable(Ark.constant(0.1, {32}));

    // ==========================<With MetaParameter()>=========================
    ///*
    // * @breif: MetaParameter initialize with its Usage
    // *         And initialize Opertor
    ...
    ///*
    // * @breif: initialize Opertor, and it can be work
    // */
    ...
    // W_conv2 = Ark.Variable(Ark.truncated_normal({5, 5, 32, 64}, stddev=0.1));
    // b_conv2 = Ark.Variable(Ark.constant(0.1, {64}));
